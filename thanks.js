...
function openClose() {
  ...
  if (sideNav.style.width != "250px") {
    ...
    // navo.style.marginLeft = "250px"
    // navo.style.transition = "0.5s"
...
var panelp1 = document.getElementById("panelp1");
var panelp2 = document.getElementById("panelp2");
function change() {
  ...
  if (moonsun.className === "fas fa-moon") {
    ...
    panelp.style.color = "white";
    panelp1.style.color = "white";
    panelp2.style.color = "white";
